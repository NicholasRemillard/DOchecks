...
if(compare_files_yesno == "yes"){ # If comparing two videos and doing quality control
  ...
  # Compare only periods with behaviors of interest
    ...
    # Calculate percent agreement for behavior (2 videos only)
    beh_int_agree <- calc_perc_agreement(beh_int_frame1, beh_int_frame2)
    beh_int_perc_agree <- beh_int_agree$percent_agreement
    beh_int_agree_frame <- beh_int_agree$agreement_frame
    
    # Calculate percent agreement for modifier (2 videos only)
    mod_int_agree <- calc_perc_agreement(beh_int_frame1, beh_int_frame2)
    mod_int_perc_agree <- mod_int_agree$percent_agreement
    mod_int_agree_frame <- mod_int_agree$agreement_frame
